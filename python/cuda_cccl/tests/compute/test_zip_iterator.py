...
def test_caching_zip_iterator():
    ...
    from cuda.compute._cpp_codegen import compile_cpp_to_ltoir
    ...
    for i in range(5):
        ...
        z = ZipIterator(arr)
        z._compile_if_needed()  # Force compilation
        iterators.append(z)
