  ...
  std::vector<name_source_t> base_it_dereference_fns)
{
  ...
  std::string zip_it_state_src = std::format(
    "{0}\nstruct {1} {{\n{2}}};\n",
  ...
  std::string zip_it_advance_fn_src = std::format(
    ...
    std::accumulate(base_it_advance_fns.begin(), base_it_advance_fns.end(), 
                   std::string{}, [](const std::string& acc, const name_source_t& fn) {
                     return acc + fn.def_src;
                   }),
    zip_it_advance_fn_name, zip_it_state_name, advance_calls);
  ...
  std::string zip_it_dereference_fn_src = std::format(
    "{0}\nextern \"C\" __device__ {1} {2}({3}* state) {{\n  return {{{4}}};\n}}\n",
    std::accumulate(base_it_dereference_fns.begin(), base_it_dereference_fns.end(), 
                   std::string{}, [](const std::string& acc, const name_source_t& fn) {
                     return acc + fn.def_src;
                   }),
    tuple_value_type, zip_it_dereference_fn_name, zip_it_state_name, deref_calls);
  ...
  std::vector<name_source_t> base_it_dereference_fns)
{
  ...
  const auto& [zip_it_state_src, zip_it_advance_fn_src, zip_it_dereference_fn_src] =
    make_zip_iterator_sources(
      zip_it_state_name,
